...
def checkForWin():
    if (button1['text'] == 'X' and button2['text'] == 'X' and button3['text'] == 'X' or
        ...
        disableButton()
        tkinter.messagebox.showinfo("XO", pa)

    elif(flag == 8):
        tkinter.messagebox.showinfo("XO", "It is a Tie")
       ...
       disableButton()
       tkinter.messagebox.showinfo("XO", playerb)

buttons = StringVar()

label = Label( tk, text="Player1:", font='Times 20 bold', bg='white', fg='red', height=1, width=8)
label.grid(row=1, column=0)

label = Label( tk, text="Player2:", font='Times 20 bold', bg='white', fg='blue', height=1, width=8)
